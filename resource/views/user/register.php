...
<div class="container col-md-4 mx-auto mt-2">
  <?php singleError(['error','pass_error'])?>
   ...
   <div class="container my-4 ">
         <?php if(!empty($errors)):?>
            <?php error_fun($errors)?>
          <?php endif;?>
     <div class="col-md-5 mx-auto border rounded p-5  mt-5" style="box-shadow: 0px 1px 3px #2a5d84;">     
          <p class="english fs-5 text-center" style="color: #2a5d84;">Please Register !</p>
         <form action="<?php echo URLROOT.'user/register'?>" method="POST" class="">
           <div class="form-floating mb-3">
            ...
            <div class="form-floating mb-3">
            <input type="text" class="form-control english" name="name" id="name" placeholder="username">
            <label for="name" class="english">User Name</label>
            </div>
            ...
            <label for="floatingPassword" class="english ">Password</label>
             ...
             <div class="d-flex justify-content-between mt-4">
                 <a href="<?php echo URLROOT .'user/login'?>" class=" english fs-6 text-decoration-underline">Already Register!please Login</a>
